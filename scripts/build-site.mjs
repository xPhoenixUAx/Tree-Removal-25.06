...
.floating-cta{position:fixed;right:24px;bottom:24px;z-index:80;display:inline-flex;align-items:center;justify-content:center;gap:10px;min-height:52px;padding:14px 20px;background:var(--green);color:#0d1212;border:1px solid rgba(255,255,255,.28);border-radius:999px;box-shadow:0 18px 44px rgba(0,0,0,.28);font:800 14px/1 Poppins,Arial,sans-serif;letter-spacing:.02em;opacity:0;visibility:hidden;pointer-events:none;transform:translateY(18px);transition:.28s opacity ease,.28s visibility ease,.28s transform ease,.22s background-color,.22s color,.22s box-shadow}.floating-cta i{font-size:16px}.floating-cta.is-visible{opacity:1;visibility:visible;pointer-events:auto;transform:translateY(0)}.floating-cta:hover{background:#fff;color:var(--deep);box-shadow:0 22px 54px rgba(0,0,0,.32);transform:translateY(-2px)}.nav-open .floating-cta,.modal-open .floating-cta{opacity:0;visibility:hidden;pointer-events:none;transform:translateY(18px)}
...
@media (max-width:820px){.floating-cta{right:14px;bottom:max(14px,env(safe-area-inset-bottom));min-height:46px;padding:12px 15px;font-size:13px;gap:8px;box-shadow:0 14px 34px rgba(0,0,0,.26)}.floating-cta i{font-size:14px}}
@media (max-width:820px){.footer-brand{gap:12px;margin-bottom:18px;align-items:center;max-width:100%}.footer-brand .brand-mark{width:52px;height:48px;flex:0 0 52px;border-width:2px}.footer-brand .brand-mark i{font-size:28px;transform:translateY(-1px)}.footer-brand .brand-copy{min-width:0;gap:3px}.footer-brand .brand-name{font-size:22px;line-height:1;white-space:normal}.footer-brand .brand-tagline{display:block;font-size:10px;line-height:1.15;letter-spacing:.08em;white-space:normal;max-width:210px}}
...
@media (max-width:420px){.footer-brand{gap:10px;margin-bottom:16px}.footer-brand .brand-mark{width:46px;height:42px;flex-basis:46px;border-radius:0}.footer-brand .brand-mark i{font-size:25px}.footer-brand .brand-name{font-size:19px;max-width:none;overflow:visible;text-overflow:clip}.footer-brand .brand-tagline{font-size:9px;max-width:180px}}
...
@media (max-width:820px){.topbar{display:none}.navrow{height:74px}.menu-toggle{display:block;position:relative;z-index:90}.menu{position:fixed;inset:0;width:100vw;height:100dvh;background:#fff;box-shadow:var(--shadow);padding:112px 20px 34px;display:flex;flex-direction:column;align-items:flex-start;overflow-y:auto;overflow-x:hidden;overscroll-behavior:contain;opacity:0;visibility:hidden;pointer-events:none;transform:translateX(-100%);transition:.42s transform ease,.28s opacity ease,.42s visibility ease}.menu.is-open{opacity:1;visibility:visible;pointer-events:auto;transform:translateX(0)}.nav-open{overflow:hidden}.nav-phone{width:100%}.hero{min-height:650px;background-attachment:scroll}.stats{grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;border:0;margin-top:0;background:var(--line);box-shadow:0 12px 30px rgba(17,21,22,.1)}.stat{padding:16px 10px 14px;border:0;background:#fff;min-height:86px;display:grid;align-content:center}.stat strong{font-size:30px;line-height:.95}.stat span{font-size:12px;line-height:1.25;color:var(--muted)}.process-list{grid-template-columns:repeat(2,minmax(0,1fr));gap:1px}.process-step{min-height:156px;padding:18px 14px 16px}.process-step span{font-size:24px;margin-bottom:10px}.process-step h3{font-size:18px;line-height:1.1;margin:0 0 7px}.process-step p{font-size:13px;line-height:1.35;margin:0}.process-step:hover,.process-step:focus-within{transform:translateY(-3px)}.faq-list{gap:8px}.faq-item{border-left-width:4px;padding:16px 16px 15px;box-shadow:0 10px 24px rgba(17,21,22,.07)}.faq-item:hover{transform:translateY(-2px);box-shadow:0 14px 30px rgba(17,21,22,.1)}.faq-item h3{font-size:17px;line-height:1.16;margin-bottom:6px}.faq-item p{font-size:13px;line-height:1.42}.split,.detail-grid,.faq-grid{grid-template-columns:1fr}.service-grid{grid-template-columns:1fr}.service-group-grid{gap:12px}.service-group-card{min-height:310px}.service-group-card .service-card-body{padding:20px}.service-group-card .kicker{font-size:11px;letter-spacing:.06em}.service-group-card .service-card-body h3{font-size:21px;line-height:1.08;margin:6px 0 8px}.service-group-card p{font-size:13px;line-height:1.38;margin:0}.group-links{gap:7px;margin-top:14px}.group-links .text-link{padding-top:7px;font-size:13px;line-height:1.2}.section{padding:76px 0}.hero p,.page-hero p{font-size:18px}.footer-grid{grid-template-columns:1fr}.form-grid{grid-template-columns:1fr}.form-grid .full{grid-column:auto}.sidebar-card,.faq-note{position:static}.cta-band{background-attachment:scroll}.container{width:min(calc(100% - 28px),var(--container))}}
...
@media (max-width:820px){.site-header .container{width:min(calc(100% - 28px),var(--container))}.navrow{height:82px}.header-brand .brand-mark{width:52px;height:50px;flex-basis:52px}.header-brand .brand-mark i{font-size:28px}.menu-toggle span{background:var(--green);transition:.25s transform,.25s opacity}.menu-toggle[aria-expanded="true"] span:nth-child(1){transform:translateY(9px) rotate(45deg)}.menu-toggle[aria-expanded="true"] span:nth-child(2){opacity:0}.menu-toggle[aria-expanded="true"] span:nth-child(3){transform:translateY(-9px) rotate(-45deg)}.menu{background:#0d1212;border:0;box-shadow:0 20px 46px rgba(0,0,0,.28);gap:18px;max-width:none;justify-content:flex-start}.menu>a{color:#fff}.menu>a.is-active{color:var(--green)}.menu>a.header-phone,.nav-phone.header-phone{position:static;width:auto;font-size:24px;margin-top:8px;color:var(--green)}}
@media (max-width:820px){.home-menu{width:100%;max-width:100%;min-width:0;display:grid;gap:12px}.home-menu>.nav-link{width:100%;justify-content:space-between}.home-menu>.nav-link i,.about-menu>.nav-link i{transform:none}.home-menu.is-mobile-open>.nav-link i,.about-menu.is-mobile-open>.nav-link i{transform:rotate(90deg)}.home-dropdown{position:static;min-width:0;max-width:100%;width:100%;display:none;opacity:1;visibility:visible;transform:none;box-shadow:none;border-color:rgba(156,187,45,.18);padding:8px 0;overflow:hidden;box-sizing:border-box}.nav-item.is-mobile-open>.home-dropdown{display:grid}.home-dropdown a{padding:9px 14px;font-size:14px}.home-menu:hover>.nav-link i,.home-menu.is-active:hover>.nav-link i{transform:none}.home-menu.is-mobile-open:hover>.nav-link i,.home-menu.is-mobile-open.is-active:hover>.nav-link i{transform:rotate(90deg)}}
@media (max-width:820px){.dropdown-branch{min-width:0;max-width:100%;box-sizing:border-box}.dropdown-panel{position:static;min-width:0;width:calc(100% - 14px);max-width:none;display:none;opacity:1;visibility:visible;transform:none;box-shadow:none;border:0;border-left:1px solid rgba(156,187,45,.22);margin:3px 0 6px 14px;padding:4px 0 4px 10px;box-sizing:border-box}.dropdown-branch.is-mobile-open>.dropdown-panel{display:grid}.category-panel{min-width:0}.home-dropdown .dropdown-branch-link i{transform:none}.dropdown-branch.is-mobile-open>.dropdown-branch-link i{transform:rotate(90deg)}}
@media (max-width:820px){.home-dropdown a{min-width:0;white-space:normal;overflow-wrap:anywhere}.home-dropdown .dropdown-branch-link{align-items:flex-start}.home-dropdown .dropdown-branch-link i{margin-top:5px;flex:0 0 auto}}
@media (max-width:820px){.about-menu{width:100%;display:grid;gap:12px}.about-menu>.nav-link{width:100%;justify-content:space-between}.about-menu:hover>.nav-link i,.about-menu.is-active:hover>.nav-link i{transform:none}.about-menu.is-mobile-open:hover>.nav-link i,.about-menu.is-mobile-open.is-active:hover>.nav-link i{transform:rotate(90deg)}}
@media (max-width:820px){[id]{scroll-margin-top:69px}}
@media (max-width:420px){.hero h1,.page-hero h1{font-size:38px}.stats{grid-template-columns:repeat(2,minmax(0,1fr))}.stat{min-height:78px;padding:13px 8px 12px}.stat strong{font-size:26px}.stat span{font-size:11px}.process-step{min-height:148px;padding:16px 12px 14px}.process-step span{font-size:22px}.process-step h3{font-size:17px}.process-step p{font-size:12px}.faq-list{gap:6px}.faq-item{padding:12px 12px 11px}.faq-item h3{font-size:15px;line-height:1.1;margin-bottom:5px}.faq-item p{font-size:12px;line-height:1.32}.service-group-grid{gap:10px}.service-group-card{min-height:250px}.service-group-card .service-card-body{padding:15px}.service-group-card .service-card-body h3{font-size:18px;margin-bottom:6px}.service-group-card p{font-size:12px;line-height:1.32}.group-links{gap:5px;margin-top:10px}.group-links .text-link{font-size:12px;padding-top:5px}.brand{font-size:20px}.hero-actions .btn{width:100%}}
...
const numberLegalSections = (content) => {
  let index = 0;
  return content.replace(/<h2>(.*?)<\/h2>/g, (_, title) => {
    index += 1;
